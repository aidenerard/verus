"""
generate_bscan_c2_p07.py
Part 7/10 — Class 2 (delaminated)
Sims 188–219  (31 simulations × 64 A-scans = up to 1,984 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c2_p07.csv
"""
