"""
generate_bscan_c1_p07.py
Part 7/10 — Class 1 (sound)
Sims 282–329  (47 simulations × 64 A-scans = up to 3,008 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c1_p07.csv
"""
