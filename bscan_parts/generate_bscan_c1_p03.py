"""
generate_bscan_c1_p03.py
Part 3/10 — Class 1 (sound)
Sims 94–141  (47 simulations × 64 A-scans = up to 3,008 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c1_p03.csv
"""
