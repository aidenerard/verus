"""
generate_bscan_c2_p03.py
Part 3/10 — Class 2 (delaminated)
Sims 63–94  (31 simulations × 64 A-scans = up to 1,984 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c2_p03.csv
"""
