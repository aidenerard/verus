"""
generate_bscan_c1_p04.py
Part 4/10 — Class 1 (sound)
Sims 141–188  (47 simulations × 64 A-scans = up to 3,008 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c1_p04.csv
"""
