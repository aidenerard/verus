"""
generate_bscan_c1_p05.py
Part 5/10 — Class 1 (sound)
Sims 188–235  (47 simulations × 64 A-scans = up to 3,008 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c1_p05.csv
"""
