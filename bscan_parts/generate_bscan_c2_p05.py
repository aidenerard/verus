"""
generate_bscan_c2_p05.py
Part 5/10 — Class 2 (delaminated)
Sims 125–157  (32 simulations × 64 A-scans = up to 2,048 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c2_p05.csv
"""
