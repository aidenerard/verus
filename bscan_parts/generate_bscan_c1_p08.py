"""
generate_bscan_c1_p08.py
Part 8/10 — Class 1 (sound)
Sims 329–376  (47 simulations × 64 A-scans = up to 3,008 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c1_p08.csv
"""
