"""
generate_bscan_c1_p01.py
Part 1/10 — Class 1 (sound)
Sims 0–47  (47 simulations × 64 A-scans = up to 3,008 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c1_p01.csv
"""
