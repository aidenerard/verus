"""
generate_bscan_c2_p01.py
Part 1/10 — Class 2 (delaminated)
Sims 0–32  (32 simulations × 64 A-scans = up to 2,048 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c2_p01.csv
"""
