"""
generate_bscan_c1_p09.py
Part 9/10 — Class 1 (sound)
Sims 376–423  (47 simulations × 64 A-scans = up to 3,008 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c1_p09.csv
"""
