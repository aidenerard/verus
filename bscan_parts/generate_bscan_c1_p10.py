"""
generate_bscan_c1_p10.py
Part 10/10 — Class 1 (sound)
Sims 423–470  (47 simulations × 64 A-scans = up to 3,008 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c1_p10.csv
"""
...
try:
    ...
    signals = generate_bscan(n_sims, label=CLASS_LABEL, param_fn=class1_params,
