"""
generate_bscan_c2_p09.py
Part 9/10 — Class 2 (delaminated)
Sims 250–282  (32 simulations × 64 A-scans = up to 2,048 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c2_p09.csv
"""
