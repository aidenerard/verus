"""
generate_bscan_c2_p06.py
Part 6/10 — Class 2 (delaminated)
Sims 157–188  (31 simulations × 64 A-scans = up to 1,984 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c2_p06.csv
"""
