"""
generate_bscan_c2_p04.py
Part 4/10 — Class 2 (delaminated)
Sims 94–125  (31 simulations × 64 A-scans = up to 1,984 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c2_p04.csv
"""
