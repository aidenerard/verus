"""
generate_bscan_c1_p06.py
Part 6/10 — Class 1 (sound)
Sims 235–282  (47 simulations × 64 A-scans = up to 3,008 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c1_p06.csv
"""
