"""
generate_bscan_c2_p02.py
Part 2/10 — Class 2 (delaminated)
Sims 32–63  (31 simulations × 64 A-scans = up to 1,984 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c2_p02.csv
"""
