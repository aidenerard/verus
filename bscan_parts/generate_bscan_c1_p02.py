"""
generate_bscan_c1_p02.py
Part 2/10 — Class 1 (sound)
Sims 47–94  (47 simulations × 64 A-scans = up to 3,008 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c1_p02.csv
"""
