"""
generate_bscan_c2_p10.py
Part 10/10 — Class 2 (delaminated)
Sims 282–313  (31 simulations × 64 A-scans = up to 1,984 signals)
Run on Kaggle CPU.
Output: /kaggle/working/synthetic_bscan_c2_p10.csv
"""
